...
Logistic <- function(data, colnum, numresamples, remove_VIF_greater_than, remove_ensemble_correlations_greater_than,
  ...
  lasso_ROC <- pROC::ggroc(lasso_roc_obj, color = "steelblue", linewidth = 2) +
  ...
  qda_ROC <- pROC::ggroc(qda_roc_obj, color = "steelblue", linewidth = 2) +
  ...
  ridge_ROC <- pROC::ggroc(ridge_roc_obj, color = "steelblue", linewidth = 2) +
  ...
  ensemble_gb_ROC <- pROC::ggroc(ensemble_gb_roc_obj, color = "steelblue", linewidth = 2) +
  ...
  ensemble_lasso_ROC <- pROC::ggroc(ensemble_lasso_roc_obj, color = "steelblue", linewidth = 2) +
  ...
  ensemble_pls_ROC <- pROC::ggroc(ensemble_pls_roc_obj, color = "steelblue", linewidth = 2) +
  ...
  ensemble_pda_ROC <- pROC::ggroc(ensemble_pda_roc_obj, color = "steelblue", linewidth = 2) +
  ...
  ensemble_ridge_ROC <- pROC::ggroc(ensemble_ridge_roc_obj, color = "steelblue", linewidth = 2) +
  ...
  ensemble_rpart_ROC <- pROC::ggroc(ensemble_rpart_roc_obj, color = "steelblue", linewidth = 2) +
  ...
  ensemble_tree_ROC <- pROC::ggroc(ensemble_tree_roc_obj, color = "steelblue", linewidth = 2) +
